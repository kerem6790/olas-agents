...
DEFAULT_PACKAGES = {
    (ComponentType.CONNECTION, "keremgegek/abci:latest"),
    (ComponentType.CONTRACT, "keremgegek/gnosis_safe:latest"),
    (ComponentType.CONTRACT, "keremgegek/gnosis_safe_proxy_factory:latest"),
    (ComponentType.PROTOCOL, "keremgegek/abci:latest"),
    (ComponentType.SKILL, "keremgegek/abstract_abci:latest"),
    (ComponentType.SKILL, "keremgegek/abstract_round_abci:latest"),
    (ComponentType.SKILL, "keremgegek/registration_abci:latest"),
    (ComponentType.SKILL, "keremgegek/transaction_settlement_abci:latest"),
}
