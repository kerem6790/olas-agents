...
def main() -> None:
    ...
    python_files = filter(
        ...
        itertools.chain(
            ...
            Path("tests").glob("**/*.py"),
            Path("packages", "keremgegek", "agents").glob("**/*.py"),
            Path("packages", "keremgegek", "connections", "abci").glob("**/*.py"),
            Path("packages", "keremgegek", "contracts").glob("**/*.py"),
            Path("packages", "keremgegek", "skills").glob("**/*.py"),
            Path("tests").glob("**/*.py"),
